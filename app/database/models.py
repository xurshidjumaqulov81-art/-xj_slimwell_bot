...
class User(Base):
    ...
    personal_id: Mapped[str | None] = mapped_column(String(7), unique=True, index=True, nullable=True)
    ...
    weights: Mapped[list["WeightHistory"]] = relationship(back_populates="user", cascade="all, delete-orphan")
    foods: Mapped[list["FoodHistory"]] = relationship(back_populates="user", cascade="all, delete-orphan")
